...
const TransaksiBerhasil = () => {
  ...
  return (
    <div className="container py-5 lg:py-[20px] pb-[50px]">
      <p
        className="text-heading-5 text-center font-bold pb-[15px]"
        tabIndex={0}
      >
        Transaksi Berhasil
      </p>
      ...
      <div className="lg:flex justify-center">
        <img
          ...
          alt=""
        />
        <Card className="px-5 py-3 lg:w-[40%] text-primary-100 shadow-lg lg:mr-32">
          <div>
          ...
          <p tabIndex={0} className="font-bold text-lg">
            Detail
          </p>
          <div className="flex justify-between mt-4">
            <div className="text-neutral-300 font-normal">
              ...
              <p className="font-bold text-lg" tabIndex={0}>
                {isTahapanBCA || isQRIS ? 'Nominal Transfer' : 'Nominal Top Up'}
              </p>
              <p className="font-bold text-lg" tabIndex={0}>
                Biaya Admin
              </p>
            ...
            <div className="flex flex-col items-end">
              {isQRIS && (
                <p className="font-bold text-lg md:text-right" tabIndex={0}>
