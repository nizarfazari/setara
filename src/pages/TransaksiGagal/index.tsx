  ...
  return (
    <div className="flex justify-center items-center container mt-10">
      <div className="text-center md:w-[600px] mb-[50px]">
        ...
        <button
          onClick={handleHome}
          className="bg-primary-300 w-full p-3 rounded-xl text-primary-100 font-bold mt-7 hover:bg-primary-100 hover:text-white transition duration-300 ease-in-out"
        >
          Kembali ke HomePage
        </button>
      </div>
